...
class TestManagerLifeCycle(object):
    def test_manager_creating_node(self, testbed_setup):

        manager, worker, graph, gen_node, con_node = testbed_setup
        manager._register_graph(graph)

        # Create Node
        future = manager._request_node_creation(
    ...
    def test_manager_create_connections(self, testbed_setup):
    ...
    def test_manager_lifecycle_graph(self, testbed_setup):
